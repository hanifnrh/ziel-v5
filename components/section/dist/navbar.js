...
function ResponsiveNavbar() {
    ...
    return (React.createElement("div", { className: mono_1.GeistMono.className + " fixed top-2 z-50 w-full items transition-all duration-300 max-w-screen-2xl px-4 md:px-10 xl:px-14" },
