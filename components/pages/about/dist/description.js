...
function Description() {
    return (React.createElement("div", { className: "relative flex flex-col px-8 md:px-20 xl:px-28 pb-10" },
        ...
        React.createElement("div", { className: "flex flex-col sm:flex-row gap-8 items-center" },
            ...
            React.createElement("div", { className: "order-1 sm:order-2 w-full flex flex-col gap-4" },
                React.createElement("h3", { className: "flex text-4xl sm:text-3xl font-normal lg:text-5xl body tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-400 dark:bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)]" }, "Functionality & Aesthetics"),
