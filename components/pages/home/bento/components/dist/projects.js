...
function Projects() {
    return (React.createElement(animated_card_1.MainMenusGradientCard, { title: "Projects", description: "Projects I have been working on and finished, both personal and work projects." },
        React.createElement("h2", { className: "text-sm text-neutral-400 group mr-auto px-5 py-2 bg-gradient-to-tr from-neutral-300/5 via-neutral-400/5 to-transparent border-[2px] border-white/5 rounded-3xl w-fit flex items-center" },
            ...
            "Projects"),
        React.createElement("ul", { className: "body-light flex flex-col gap-4 my-5" }, projects.map(function (project) { return (React.createElement("li", { key: project.name },
            React.createElement(link_1["default"], { href: project.href, rel: "canonical", target: "_blank", className: "border-b py-2 w-full flex justify-between text-neutral-200" },
                project.name,
