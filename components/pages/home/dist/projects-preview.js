        ...
        React.createElement("div", { className: "z-10" },
            React.createElement("div", { className: "px-4 md:px-10 xl:px-14 py-5" },
                React.createElement("h2", { className: "flex bg-purple-600/20 text-purple-600 px-4 py-2 rounded-full w-fit" },
                    ...
                    "Projects")),
            React.createElement("div", { className: "relative px-4 md:px-10 xl:px-14 pb-10 flex flex-col gap-4 sm:gap-0 sm:flex-row justify-between" },
                ...
                React.createElement(link_1["default"], { href: "/projects", rel: "canonical", className: "sm:w-1/3 xl:w-1/2 text-neutral-200 flex justify-start items-start sm:justify-end" },
                    React.createElement(spotlight_button_1.SpotlightButton, null))),
            React.createElement("div", { className: "relative flex flex-col items-center px-4 md:px-10 xl:px-14 pb-20 bg-background", id: "projects" },
