...
function Bento() {
    ...
    return (React.createElement("div", { className: "w-full grid grid-cols-1 xl:grid-cols-[3fr_1fr] gap-2 pb-20 px-4 md:px-10 xl:px-14 text-neutral-200" },
        React.createElement("div", { className: "w-full gap-2 grid grid-cols-1" },
            React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-2" },
                React.createElement(animated_card_1.MainMenusGradientCard, { description: "Design tools and code tools I mainly use. Focused on React or Javascript ecosystem, recently have been using Next.js", title: "Tech stack I mainly use" },
                    React.createElement("h2", { className: "text-sm text-neutral-400 group mr-auto px-5 py-2 bg-gradient-to-tr from-neutral-300/5 via-neutral-400/5 to-transparent  border-[2px] border-white/5 rounded-3xl w-fit flex items-center" },
                    ...
                    React.createElement("section", { id: "logos" },
                        React.createElement("div", { className: "container mx-auto " },
                            React.createElement("div", { className: "relative mt-6" },
                                React.createElement(marquee_1.Marquee, { className: "max-w-full [--duration:40s]" }, companies.map(function (company, idx) { return (React.createElement(image_1["default"], { key: idx, width: 112, height: 40, src: company.url, className: "h-10 w-28 object-contain opacity-30 neutralscale brightness-0 invert", alt: company.name })); })),
                ...
                React.createElement("div", { className: "hidden lg:block" },
                    React.createElement(bento_card_1.BentoCard, null,
                        React.createElement("h2", { className: "text-sm text-neutral-400 group mr-auto px-5 py-2 bg-gradient-to-tr from-neutral-300/5 via-neutral-400/5 to-transparent  border-[2px] border-white/5 rounded-3xl w-fit flex items-center" },
                            ...
                            "Typing Speed"),
                        React.createElement("div", { className: "mt-5 flex justify-start items-end  body-bold text-neutral-200" },
                            React.createElement("h3", { className: "text-6xl xl:text-8xl" }, "116"),
                            React.createElement("p", { className: "text-lg" }, "wpm")),
                        React.createElement("div", { className: "mt-5  flex sm:items-start gap-2 lg:gap-0 lg:justify-between body-light text-sm text-neutral-200" },
                ...
                React.createElement("div", { className: "" },
                    React.createElement(bento_card_1.BentoCard, null,
                        React.createElement("h2", { className: "text-sm text-neutral-400 group mr-auto px-5 py-2 bg-gradient-to-tr from-neutral-300/5 via-neutral-400/5 to-transparent  border-[2px] border-white/5 rounded-3xl w-fit flex items-center" },
                            ...
                            "Location"),
                        React.createElement("div", { className: "rounded-xl mt-5" },
                            React.createElement("div", { className: "relative rounded-xl" },
                                React.createElement(image_1["default"], { src: "/location.png", width: 1000, height: 1000, alt: "Location in Bekasi, West Java", className: "w-full z-20 rounded-xl object-cover aspect-video neutralscale invert" }),
                                React.createElement("div", { className: "absolute inset-0 bg-purple-800 opacity-70 mix-blend-soft-light rounded-xl" }))))),
                React.createElement("div", { className: "" },
                    React.createElement(bento_card_1.BentoCard, null,
                        React.createElement("h2", { className: "text-sm text-neutral-400 group mr-auto px-5 py-2 bg-gradient-to-tr from-neutral-300/5 via-neutral-400/5 to-transparent  border-[2px] border-white/5 rounded-3xl w-fit flex items-center" },
                            React.createElement(fa_1.FaRegKeyboard, { className: "inline w-4 h-4 mr-2  duration-300" }),
                    ...
                    React.createElement(bento_card_1.BentoCard, null,
                        React.createElement("div", { className: "flex justify-between items-center " },
                            React.createElement("h2", { className: "text-sm  text-neutral-400 group mr-auto px-5 py-2 bg-gradient-to-tr from-neutral-300/5 via-neutral-400/5 to-transparent  border-[2px] border-white/5 rounded-3xl w-fit flex items-center" },
                                ...
                                "Spotify Last Played"),
                            React.createElement("div", { className: "text-neutral-200 text-3xl group-hover:text-green-600" },
                                React.createElement(fa_1.FaSpotify, null))),
                        React.createElement("div", { className: "flex flex-row gap-4 mt-5 items-center" },
                            React.createElement(image_1["default"], { src: track.albumImageUrl, width: 1000, height: 1000, alt: "Spotify Last Played", className: "sm:h-32 h-24 w-auto rounded-xl" }),
                            React.createElement("div", { className: "flex flex-col" },
                                React.createElement("h3", { className: "body text-xl line-clamp-1" }, track.name),
                                React.createElement("p", { className: "body-light text-base line-clamp-1" }, track.artist),
                                React.createElement(react_1.Link, { href: track.spotifyUrl, rel: "canonical", target: "_blank", className: "body-light text-base w-fit text-green-600 border-b border-green-600" },
                                    "Play on Spotify",
            ...
            React.createElement(animated_card_1.MainMenusGradientCard, { description: "Projects I have been working on and finished, both personal and work projects.", title: "Projects" },
                ...
                React.createElement("ul", { className: "body-light flex flex-col gap-4 my-5" },
                    React.createElement("li", null,
                        React.createElement(react_1.Link, { href: "https://realityclubmusic.netlify.app/", rel: "canonical", target: "_blank", className: "border-b py-2 w-full flex justify-between text-neutral-200" },
                            "Reality Club",
                            React.createElement(lucide_react_1.ArrowUpRight, null))),
                    React.createElement("li", null,
                        React.createElement(react_1.Link, { href: "https://www.ecofix.id/", rel: "canonical", target: "_blank", className: "border-b py-2 w-full flex justify-between text-neutral-200" },
                            "Ecofix",
                            React.createElement(lucide_react_1.ArrowUpRight, null))),
                    React.createElement("li", null,
                        React.createElement(react_1.Link, { href: "https://www.siggma-ta.com/", rel: "canonical", target: "_blank", className: "border-b py-2 w-full flex justify-between text-neutral-200" },
                            "SIGMA",
                            React.createElement(lucide_react_1.ArrowUpRight, null))),
                    React.createElement("li", null,
                        React.createElement(react_1.Link, { href: "https://www.figma.com/proto/4dpPY9tTTpaERumMd80OqI/Academiku?page-id=0%3A1&node-id=90-837&viewport=505%2C2553%2C0.87&t=tt3fxops6J46CJzg-1&scaling=scale-down&content-scaling=fixed&starting-point-node-id=290%3A1758&show-proto-sidebar=1", rel: "canonical", target: "_blank", className: "border-b py-2 w-full flex justify-between text-neutral-200" },
                            "Academiku",
                            React.createElement(lucide_react_1.ArrowUpRight, null))),
                    React.createElement("li", null,
                        React.createElement(react_1.Link, { href: "https://www.figma.com/proto/JOBOHqk9w13ZWEth8bbTTZ/jiwakita?page-id=170%3A2702&node-id=874-30730&starting-point-node-id=874%3A25000&t=doKBH4JOUhc4Ac5I-1", rel: "canonical", target: "_blank", className: "border-b py-2 w-full flex justify-between text-neutral-200" },
                            "Jiwakita",
                            React.createElement(lucide_react_1.ArrowUpRight, null))))))));
}
