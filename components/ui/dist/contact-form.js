...
var ContactForm = function () {
    ...
    return (React.createElement("div", { id: "contact" },
        React.createElement(form_1.Form, __assign({}, form),
            React.createElement("div", { className: "p-8 pb-20 px-4 md:px-10 xl:px-14 w-full" },
                    ...
                    React.createElement("div", { className: utils_1.cn("group relative p-8 rounded-xl overflow-hidden transition-all duration-300", "border border-white/10 bg-black/10", "hover:-translate-y-0.5 will-change-transform", "col-span-1", "md:col-span-2") },
                        ...
                        React.createElement("div", { className: "relative flex flex-col space-y-3" },
                            React.createElement("div", { className: "space-y-2" },
                                React.createElement("div", { className: "body flex justify-start items-center gap-4 text-neutral-100 tracking-tight text-2xl" },
                                ...
                                React.createElement("p", { className: "body-light text-md text-neutral-300 leading-snug" },
                        ...
                        React.createElement("form", { onSubmit: form.handleSubmit(submitForm), className: "space-y-5 pt-6 text-xs sm:text-base text-neutral-500 body-light" },
                            React.createElement(form_1.FormField, { control: form.control, name: "name", render: function (_a) {
                                    ...
                                    return (React.createElement(form_1.FormItem, null,
                                        React.createElement(form_1.FormLabel, { className: "text-neutral-200" }, "Name"),
                            ...
                            React.createElement(form_1.FormField, { control: form.control, name: "email", render: function (_a) {
                                    var field = _a.field;
                                    return (React.createElement(form_1.FormItem, null,
                                        React.createElement(form_1.FormLabel, { className: "text-neutral-200" }, "Email"),
                                        React.createElement(form_1.FormControl, null,
                            ...
                            React.createElement(form_1.FormField, { control: form.control, name: "message", render: function (_a) {
                                    var field = _a.field;
                                    return (React.createElement(form_1.FormItem, null,
                                        React.createElement(form_1.FormLabel, { className: "text-neutral-200" }, "Message"),
                                        React.createElement(form_1.FormControl, null,
