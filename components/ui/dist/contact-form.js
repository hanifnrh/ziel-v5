...
var z = require("zod");
var dot_pattern_1 = require("../magicui/dot-pattern");
...
var ContactForm = function () {
    ...
    return (React.createElement(form_1.Form, __assign({}, form),
        React.createElement("div", { className: "p-8 pb-20 px-8 md:px-20 2xl:px-52 w-full", id: "contact" },
            React.createElement("div", { className: "grid grid-cols-1 gap-3 max-w-7xl mx-auto" },
                React.createElement("div", { className: utils_1.cn("group relative p-8 rounded-xl overflow-hidden transition-all duration-300", "border border-white/10 bg-black/10", "hover:-translate-y-0.5 will-change-transform", "col-span-1", "md:col-span-2") },
                    ...
                    React.createElement("div", { className: "relative flex flex-col space-y-3" },
                        React.createElement("div", { className: "space-y-2" },
                            React.createElement("div", { className: "body flex justify-start items-center gap-4 text-gray-100 tracking-tight text-2xl" },
                                React.createElement("div", { className: "w-8 h-8 rounded-lg flex items-center justify-center bg-purple-600/20 text-purple-600 group-hover:bg-gradient-to-br transition-all duration-300" },
                                    React.createElement(lucide_react_1.PencilLine, null)),
                                React.createElement("h3", null, "Contact Me")),
                            React.createElement("p", { className: "body-light text-md text-gray-300 leading-snug" },
                                "Contact me here, this form will automatically send your messages to my email or directly message me to",
                                React.createElement(link_1["default"], { href: "mailto:dailyziel@gmail.com", rel: "canonical", target: "_blank", className: "text-purple-600 underline ml-2" }, "dailyziel@gmail.com")))),
                    React.createElement("div", { className: "absolute inset-0 -z-10 rounded-xl p-px bg-gradient-to-br from-transparent  to-transparent via-purple-700/10 opacity-100 transition-opacity duration-300" }),
                    React.createElement("form", { onSubmit: form.handleSubmit(submitForm), className: "space-y-5 pt-6 text-xs sm:text-base text-zinc-500 body-light" },
                        React.createElement(form_1.FormField, { control: form.control, name: "name", render: function (_a) {
                                ...
                                return (React.createElement(form_1.FormItem, null,
                                    React.createElement(form_1.FormLabel, { className: "text-zinc-200" }, "Name"),
                                    React.createElement(form_1.FormControl, null,
                                        React.createElement(input_1.Input, __assign({ type: "text", placeholder: "Type your name here", autoComplete: "true", className: "bg-neutral-950/30" }, field))),
                                    React.createElement(form_1.FormMessage, null)));
                            } }),
                        React.createElement(form_1.FormField, { control: form.control, name: "email", render: function (_a) {
                                var field = _a.field;
                                return (React.createElement(form_1.FormItem, null,
                                    React.createElement(form_1.FormLabel, { className: "text-zinc-200" }, "Email"),
                                    React.createElement(form_1.FormControl, null,
                                        React.createElement(input_1.Input, __assign({ type: "email", placeholder: "Type your email here", autoComplete: "true", className: "bg-neutral-950/30" }, field))),
                                    React.createElement(form_1.FormMessage, null)));
                            } }),
                        React.createElement(form_1.FormField, { control: form.control, name: "message", render: function (_a) {
                                var field = _a.field;
                                return (React.createElement(form_1.FormItem, null,
                                    React.createElement(form_1.FormLabel, { className: "text-zinc-200" }, "Message"),
                                    React.createElement(form_1.FormControl, null,
                                        React.createElement(textarea_1.Textarea, __assign({ placeholder: "Type your message here", className: "resize-none bg-neutral-950/30" }, field, { autoComplete: "true" }))),
                                    React.createElement(form_1.FormMessage, null)));
                            } }),
                        React.createElement("div", { className: "w-full h-full flex justify-center items-center" },
                            React.createElement(button_1.Button, { type: "submit", disabled: loading, className: "px-0 py-10" },
                                React.createElement("div", { style: { transform: "none" } },
                                    React.createElement("div", { className: "group relative inline-block cursor-pointer rounded-xl bg-zinc-900 p-px leading-6 text-white no-underline shadow-2xl shadow-zinc-900" },
