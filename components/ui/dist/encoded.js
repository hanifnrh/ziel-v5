...
var EncodedText = function () {
    ...
    return (React.createElement("div", { className: mono_1.GeistMono.className + " flex flex-col md:flex-row gap-x-5 gap-y-3 items-center" },
        ...
        React.createElement(link_1["default"], { href: "https://drive.google.com/file/d/1YVITGrnvwSLOR7WKBRs4cAaRevdYVNvf/view?usp=sharing", rel: "canonical", target: '_blank' },
            React.createElement("p", { "data-value": "CV", onMouseOver: onHover, className: "cursor-pointer uppercase text-zinc-200 hover:text-zinc-400" }, "CV")),
