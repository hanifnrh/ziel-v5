...
function UnderConstruction() {
    return (React.createElement("main", null,
        React.createElement("section", { className: "h-screen flex items-center z-10" },
            React.createElement("div", { className: "w-full h-fit text-neutral-600 gap-x-12 flex items-center justify-center p-8 pb-0 sm:py-20 gap-16 px-4 md:px-10 xl:px-14" },
