    ...
    return (
        <>
            ...
            <div className="pt-16 lg:py-28 z-10">
                <div className="px-4 md:px-10 xl:px-14 py-5">
                ...
                <div className="relative px-4 md:px-10 xl:px-14 pb-10 flex flex-col gap-4 sm:gap-0 sm:flex-row justify-between">
                ...
                {/* Project Cards */}
                <div className="relative flex flex-col items-center px-4 md:px-10 xl:px-14 pb-20 bg-background" id="projects">
                    {isLoading ? (
