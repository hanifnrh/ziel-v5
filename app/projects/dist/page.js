    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { className: "pt-16 lg:py-28 z-10" },
            ...
            React.createElement("div", { className: "relative flex flex-col items-center px-8 md:px-20 2xl:px-52 pb-20 bg-background", id: "projects" },
                React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-10 sm:gap-8 items-start" }, projects.map(function (project) { return (React.createElement(link_1["default"], { key: project.slug, href: "/projects/" + project.slug, className: "group body w-full flex flex-col gap-4 justify-center items-start text-zinc-200" },
                    ...
                    React.createElement("div", { className: "flex flex-wrap gap-2 text-xs text-zinc-200 items-center" }, project.tag.map(function (tag, index) { return (React.createElement("p", { key: index, className: "bg-zinc-200/10 px-3 py-2 text-xs rounded-sm" }, tag)); })),
