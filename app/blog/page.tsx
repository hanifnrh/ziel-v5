    ...
    return (
        <>
            <Head>
                ...
                <meta name="twitter:image" content="/images/images/thumbnail.png" />
            </Head>

            <section className="pt-24 sm:pt-28 lg:py-28 z-10 px-4 md:px-10 xl:px-14">
                    <motion.div
                        className="w-full sm:w-2/3 flex flex-col gap-4 pb-10"
