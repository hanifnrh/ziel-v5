...
function Blog() {
    ...
    react_1.useEffect(function () {
        function fetchPosts() {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var response, json, postsData, error_1;
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(head_1["default"], null,
            React.createElement("title", null, "Ziel Blog"),
            React.createElement("meta", { name: "description", content: "Read my latest blog post." }),
            React.createElement("meta", { name: "robots", content: "index, follow" }),
            React.createElement("link", { rel: "canonical", href: "https://www.ziel.works/blog" }),
            React.createElement("meta", { property: "og:type", content: "article" }),
            React.createElement("meta", { property: "og:title", content: "Ziel Blog" }),
            React.createElement("meta", { property: "og:description", content: "Read my latest blog post." }),
            React.createElement("meta", { property: "og:image", content: "/thumbnail.png" }),
            React.createElement("meta", { property: "og:url", content: "https://www.ziel.works/blog" }),
            React.createElement("meta", { name: "twitter:card", content: "summary_large_image" }),
            React.createElement("meta", { name: "twitter:title", content: "Ziel Blog" }),
            React.createElement("meta", { name: "twitter:description", content: "Read my latest blog post." }),
        ...
        React.createElement("section", { className: "pt-16 lg:py-28 z-10" },
            ...
            React.createElement("div", { className: "px-8 md:px-20 2xl:px-52 pb-10 flex flex-col sm:flex-row gap-4 sm:gap-0 justify-between" },
                React.createElement("div", { className: "w-full flex flex-col gap-4" },
                    React.createElement("h3", { className: "flex text-4xl sm:text-3xl lg:text-5xl body tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-200 dark:bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)]" }, "Thoughts, Ideas & Explorations"),
            ...
            React.createElement("div", { className: "w-full relative flex flex-col items-start px-8 md:px-20 2xl:px-52 pb-20 bg-background", id: "projects" }, isLoading ? (
            // ✅ Loader saat fetching data
            React.createElement("div", { className: "w-full flex justify-center py-20" },
                React.createElement(loader_1.Loader, null))) : (React.createElement("div", { className: "w-full grid grid-cols-1 items-start mt-5" }, posts.length > 0 ? (posts.map(function (post, index) { return (React.createElement(link_1["default"], { rel: "canonical", key: index, href: "/blog/" + post.slug, className: "w-full group border-neutral-500/20 border-t-1 py-10 body grid grid-cols-1 sm:grid-cols-[1fr_3fr] gap-4 lg:gap-6 xl:gap-8 justify-center items-start text-neutral-200" },
                React.createElement("div", { className: "aspect-[5/3] overflow-hidden rounded-xl w-full" },
                    React.createElement(image_1["default"], { src: post.featuredImage.url, width: 1000, height: 1000, className: "w-full h-full object-cover group-hover:scale-105 transition-all", alt: post.title, priority: true })),
                React.createElement("div", { className: "w-full h-full flex flex-col gap-4 justify-between" },
                    React.createElement("div", { className: "flex flex-col gap-2" },
                        ...
                        React.createElement("p", { className: "body-light text-sm sm:text-md text-neutral-500 line-clamp-3" }, post.description)),
