...
function Blog() {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("section", { className: "pt-16 lg:py-28 z-10" },
            React.createElement("div", { className: "px-4 md:px-10 xl:px-14 py-5" },
                React.createElement("h2", { className: "flex bg-purple-600/20 text-purple-600 px-4 py-2 rounded-full w-fit" },
                    ...
                    "Blog")),
            React.createElement("div", { className: "px-4 md:px-10 xl:px-14 pb-10 flex flex-col sm:flex-row gap-4 sm:gap-0 justify-between" },
            ...
            React.createElement("div", { className: "w-full relative flex flex-col items-start px-4 md:px-10 xl:px-14 pb-20 bg-background", id: "projects" }, isLoading ? (
